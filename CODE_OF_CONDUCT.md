...
This is the same private channel described in [SECURITY.md](SECURITY.md). It is
used here because the maintainer has chosen not to publish an email address for
this project; the channel is private to the maintainer, so reports are not
